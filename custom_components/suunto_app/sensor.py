...
_DISPLAY_PRECISION: dict[str, int] = {
    ...
    "last_descent": 0, "last_ascent_time": 0, "last_descent_time": 0,
...
SENSORS: tuple[SuuntoAppSensorDescription, ...] = (
    ...
    SuuntoAppSensorDescription(
        key="last_descent",
        translation_key="last_descent",
        native_unit_of_measurement=UnitOfLength.METERS,
        device_class=SensorDeviceClass.DISTANCE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:slope-downhill",
        value_fn=_section("workout", "descent_meters"),
    ),
    SuuntoAppSensorDescription(
        key="last_ascent_time",
        translation_key="last_ascent_time",
        native_unit_of_measurement=UnitOfTime.MINUTES,
        device_class=SensorDeviceClass.DURATION,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:arrow-up-bold",
        value_fn=_section("workout", "ascent_time_minutes"),
    ),
    SuuntoAppSensorDescription(
        key="last_descent_time",
        translation_key="last_descent_time",
        native_unit_of_measurement=UnitOfTime.MINUTES,
        device_class=SensorDeviceClass.DURATION,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:arrow-down-bold",
        value_fn=_section("workout", "descent_time_minutes"),
    ),
    SuuntoAppSensorDescription(
        key="last_min_altitude",
        translation_key="last_min_altitude",
        native_unit_of_measurement=UnitOfLength.METERS,
        device_class=SensorDeviceClass.DISTANCE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:arrow-collapse-down",
        value_fn=_section("workout", "min_altitude_meters"),
    ),
    SuuntoAppSensorDescription(
        key="last_max_altitude",
        translation_key="last_max_altitude",
        native_unit_of_measurement=UnitOfLength.METERS,
        device_class=SensorDeviceClass.DISTANCE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:summit",
        value_fn=_section("workout", "max_altitude_meters"),
    ),
    # Peak Training Effect: Suunto's own 1..5 rating of the session's impact.
    SuuntoAppSensorDescription(
        key="last_pte",
        translation_key="last_pte",
        state_class=SensorStateClass.MEASUREMENT,
